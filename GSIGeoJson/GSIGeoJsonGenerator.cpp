...
GSIGeoJsonGenerator::GSIGeoJsonGenerator()
{
}
...
QString GSIGeoJsonGenerator::asString(const QVariant & value) const
{
	QString out;
	out.reserve(200);
	traverse(value, out);
...
void GSIGeoJsonGenerator::traverse(const QVariant & value, QString & out) const
{
	switch (value.type()) {
	case QVariant::Map:
	{
